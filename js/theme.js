...
(function ($) {
  ...
  /*  Menu scroll js
    /*----------------------------------------------------*/
  const nav_offset_top = $('.header_area').offset().top;
  function stickyHeader() {
    if ($('.header_area').length) {
      const strickyScrollPos = nav_offset_top;
  ...
  function our_gallery() {
    if ($('.portfolio_area').length) {
      ...
      $('.portfolio_list_inner').imagesLoaded(() => {
  ...
  function bodyScrollAnimation() {
    const scrollAnimate = $('body').data('scroll-animation');
